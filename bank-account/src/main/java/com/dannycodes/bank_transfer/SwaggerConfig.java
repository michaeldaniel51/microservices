...
@OpenAPIDefinition(servers = { @Server(url = "https://localhost:8087")}, info = @Info(title = "Bank Service", description = "This lists all the Bank Service API Calls. The Calls are OAuth2 secured, "
